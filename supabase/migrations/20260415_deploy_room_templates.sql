...
('GW 정기배포', 'groupware', 'regular', array['https://gitlab.hmc.co.kr/hmg-groupware/hmg-groupware-portal/assemble-fe'], array[]::text[], '[{"title":"배포대장 및 배포 전 할 일 확인","assignee":"all"},{"title":"feature -> release 머지 확인","assignee":"member"},{"title":"release -> main 머지","assignee":"leader"},{"title":"배포 의존도 확인","assignee":"all"},{"title":"main 로컬 구동 모니터링","assignee":"all"},{"title":"블랙덕/소나큐브 확인","assignee":"member"},{"title":"배포 후 할 일 확인","assignee":"all"},{"title":"배포 태그 발행","assignee":"leader"},{"title":"배포 후 운영계 모니터링","assignee":"all"},{"title":"main -> stage(stage2), dev, release 현행화/배포","assignee":"member"}]'::jsonb),
('GW 비정기배포', 'groupware', 'adhoc', array['https://gitlab.hmc.co.kr/hmg-groupware/hmg-groupware-portal/assemble-fe'], array[]::text[], '[{"title":"배포대장 및 배포 전 할 일 확인","assignee":"all"},{"title":"feature -> release 머지 확인","assignee":"member"},{"title":"release -> main 머지","assignee":"leader"},{"title":"배포 의존도 확인","assignee":"all"},{"title":"main 로컬 구동 모니터링","assignee":"all"},{"title":"블랙덕/소나큐브 확인","assignee":"member"},{"title":"배포 후 할 일 확인","assignee":"all"},{"title":"배포 태그 발행","assignee":"leader"},{"title":"배포 후 운영계 모니터링","assignee":"all"},{"title":"main -> stage(stage2), dev, release 현행화/배포","assignee":"member"}]'::jsonb),
('GW 핫픽스', 'groupware', 'hotfix', array['https://gitlab.hmc.co.kr/hmg-groupware/hmg-groupware-portal/assemble-fe'], array[]::text[], '[{"title":"배포대장 및 배포 전 할 일 확인","assignee":"all"},{"title":"feature -> release 머지 확인","assignee":"member"},{"title":"release -> main 머지","assignee":"leader"},{"title":"배포 의존도 확인","assignee":"all"},{"title":"main 로컬 구동 모니터링","assignee":"all"},{"title":"블랙덕/소나큐브 확인","assignee":"member"},{"title":"배포 후 할 일 확인","assignee":"all"},{"title":"배포 태그 발행","assignee":"leader"},{"title":"배포 후 운영계 모니터링","assignee":"all"},{"title":"main -> stage(stage2), dev, release 현행화/배포","assignee":"member"}]'::jsonb),
